...
describe('arcade catalog', () => {
  it('keeps 28 games plus one Meta-Arcade hall with unique scene identifiers', () => {
    expect(ARCADE_GAMES).toHaveLength(29);
    expect(new Set(ARCADE_GAMES.map(game => game.scene)).size).toBe(29);
