...
export const TRACKS: Record<string, TrackerTrack> = {
  ...
  chrono:{id:'chrono',title:'Broken Clock Signal',bpm:136,stepsPerBeat:4,voices:{LEAD:notes(72,76,79,0,71,74,79,83,69,72,76,0,67,71,74,78),ARP:notes(48,55,60,63,47,54,59,62,45,52,57,60,43,50,55,59),BASS:notes(24,0,24,31,23,0,23,30,21,0,21,28,19,0,19,26),DRUMS:drums('KICK','HAT','SNARE',0,'KICK','HAT','SNARE','HAT','KICK',0,'SNARE','HAT','KICK','KICK','SNARE','HAT')}},
  paradox:{id:'paradox',title:'Impossible Entry',bpm:128,stepsPerBeat:4,voices:{LEAD:notes(72,75,79,84,71,74,78,83,68,72,75,80,66,70,73,78),ARP:notes(48,55,60,63,47,54,59,62,44,51,56,59,42,49,54,57),BASS:notes(24,0,31,24,23,0,30,23,20,0,27,20,18,0,25,18),DRUMS:drums('KICK','HAT',0,'HAT','SNARE','HAT','KICK','HAT','KICK',0,'SNARE','HAT','KICK','KICK','SNARE','HAT')}},
};
