...
export class ModManagerController {
  ...
  constructor() {
    this.root = document.createElement('aside'); this.root.id = 'mod-manager'; this.root.className = 'mod-manager'; this.root.hidden = true; this.root.dataset.arcadeOverlay = 'true';
    ...
    const studio = document.createElement('button'); studio.id = 'visual-studio-toggle'; studio.type = 'button'; studio.textContent = 'VISUAL STUDIO'; this.root.querySelector('header')?.appendChild(studio);
