...
- **Reliable Pause Restart** - Use Escape or controller Start to pause an active game, quit only through the explicit Pause menu action, and restart without losing the active difficulty, local co-op mode, or versus mode configuration.
